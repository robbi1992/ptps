...
-- ----------------------------
BEGIN;
INSERT INTO `import` VALUES (23, '23/IS/T/KPU.03/2021', '2021-10-08', '1', 'nama lengkap', 'alamat lengkap', 'nomor paspor', 90, '1', 141, 142, 'inv123', '2021-10-08', 'pengangkut', '3', '0', '2021-10-08 21:05:48', '123123123123123123', 'Robbi Amirudin', '2021-10-09', 143, '2021-10-10', 'sesuai', 'sesuai', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_account` VALUES (17, 'nama rek', 'no rek', 'bank', 23);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_guarantee` VALUES (17, '1', 'penjamin', 'alamat', 1000000, 23);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_items` VALUES (21, 'barang1', 1, 1, '', 1, 'USD', 14294, 64323, 30, 49315, 0, 0, 10, 10, 10, 23);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_reexport_attachments` VALUES (1, 'IS_1633749042_104.jpg', 23);
INSERT INTO `import_reexport_attachments` VALUES (2, 'IS_1633749096_842.jpg', 23);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_sponsor` VALUES (9, 'nama sponsor', 'alamat', '0812312123', '123321123', 'lokasi pengunaan', 'tujuan penggunaan', 23);
COMMIT;
