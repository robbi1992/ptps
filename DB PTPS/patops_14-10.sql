...
-- ----------------------------
BEGIN;
INSERT INTO `import` VALUES (24, '24/IS/KPU.03/2021', '2021-10-13', '3', 'nama lengkap', 'hvjhjkbhg', 'asgdhvk', 90, '1', 143, 143, 'ingfv', '2021-10-13', 'khjbjknkk', '2', '0', '2021-10-13 19:57:51', '123123123123123123', 'Robbi Amirudin', '2021-10-14', NULL, NULL, NULL, NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_account` VALUES (18, 'jhvhb', 'noiuhu', 'hgvvjjn', 24);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_guarantee` VALUES (18, '2', 'asd', 'asdas', 147700, 'asdsa', 'asdas', 24);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_items` VALUES (24, 'barang1', 1, 1, 'tes', 4, 'AUD', 10386.8, 15, 30, 10, 10, 10, 10, 10, 10, 10, 24);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_items_temp` VALUES (13, 'barang1', 1, 1, '', 1, 'CNY', 2208.38, 15, 120, 0, 10, 10, 10, 100, 10, 10, '1634129576248', '1634129408104');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_sponsor` VALUES (10, 'jblk', 'sgfhcjvlk', 'hjgh', 'hjgkhkj', 'dhgfjhjl', 'dghvjkn', 24);
COMMIT;
