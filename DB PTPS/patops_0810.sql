...
-- ----------------------------
BEGIN;
INSERT INTO `import` VALUES (20, '20/IS/T/KPU.03/2021', '2021-10-08', '2', 'asd', 'asd', 'asd', 90, '1', 143, 143, 'asdasda', '2021-10-08', 'asdsa', '1', '0', '2021-10-08 02:21:25', '123123123123123123', 'Robbi Amirudin', '2021-10-09');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_account` VALUES (14, 'asdas', 'asdsa', 'asdsa', 20);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_guarantee` VALUES (14, '1', 'asds', 'asd', 0, 20);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_items` VALUES (18, 'asdas', 1, 1, '', 1, 'MYR', 3415.91, 0, 1000, 0, 0, 0, 20);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_items_attachment` VALUES (7, 'IS_1633634473_100.jpg', 18);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `import_sponsor` VALUES (6, 'asd', 'asd', 'asd', 'asd', 'asd', 'asd', 20);
COMMIT;
