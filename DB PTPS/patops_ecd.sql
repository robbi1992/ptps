...
-- ----------------------------
BEGIN;
INSERT INTO `arr_valas` VALUES (1, '1/KD/VALAS/SH/2021', 'asd', '2021-10-26', 1, 4, 'asdsa', '2021-10-25', 'asdsa', 'asd', 'asdsa', 'asdas', 'asd', 'asd', '3', '1', '1', '1', '3', '0', '1', '1', 'Robbi Amirudin', '123123123123123123', '2021-10-24 19:28:09', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `arr_valas_cash` VALUES (1, 'yen', 100, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `dep_valas` VALUES (1, '1/KB/VALAS/SH/2021', 'asd', '2021-10-17', 4, 4, '123122112', '2021-10-18', 'jknkl', 'nklnl', 'jnklk', 'nlnklml', 'kllnkl', 'klnnkl', '2', '1', '1', '1', '3', '0', '1', '1', '0', 'asds', '2021-10-17', 'KPU BEA DAN CUKAI TIPE C SOEKARNO-HATTA', 'Robbi Amirudin', '123123123123123123', '0', '2021-10-17 17:51:36');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `docs` VALUES (1, 'asd', 'dsa', '2021-10-23', '1634889451.jpg', 2);
INSERT INTO `docs` VALUES (2, 'asd', 'dsa', '2021-10-23', '1634889451.jpg', 3);
INSERT INTO `docs` VALUES (3, 'asd', 'asd', '2021-10-23', '1634889803.jpg', 3);
...
-- ----------------------------
-- Table structure for ecd_declare_answer
-- ----------------------------
DROP TABLE IF EXISTS `ecd_declare_answer`;
CREATE TABLE `ecd_declare_answer` (
  `id` bigint(20) NOT NULL,
  `goods_declare_id` int(11) NOT NULL,
  `personal_id` bigint(20) NOT NULL,
  `answer` enum('0','1') NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ecd_da_declare_id_fk_pers_id` (`goods_declare_id`),
  KEY `ecd_da_person_id_fk_pers_id` (`personal_id`),
  CONSTRAINT `ecd_da_declare_id_fk_pers_id` FOREIGN KEY (`goods_declare_id`) REFERENCES `ecd_goods_declare` (`id`),
  CONSTRAINT `ecd_da_person_id_fk_pers_id` FOREIGN KEY (`personal_id`) REFERENCES `ecd_personal` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- ----------------------------
BEGIN;
INSERT INTO `import` VALUES (31, '31/IS/KPU.03/2021', '2021-10-16', '2', 'Robbi Amirudin', 'Jonggol', '123321123', 14, '1', 143, 143, 'inv123', '2021-10-16', 'pengangkut', '3', '0', '2021-10-16 13:59:15', '123123123123123123', 'Robbi Amirudin', '2021-10-30', 143, '2021-10-22', '31/BPJ/KPU.03/2021', '', 'asdas tempo', '2');
INSERT INTO `import` VALUES (32, '32/IS/KPU.03/2021', '2021-10-18', '1', 'Robbi Amirudin', 'Alamat lengkap', 'nomor paspor', 30, '1', 143, 143, 'inv123', '2021-10-20', 'pengangkut', '3', '0', '2021-10-18 09:02:22', '123123123123123123', 'Robbi Amirudin', '2021-11-17', NULL, '2021-10-22', '32/BPJ/KPU.03/2021', NULL, 'jatuh tempo', '2');
...
-- ----------------------------
-- Records of import_reexport_attachments
-- ----------------------------
BEGIN;
INSERT INTO `import_reexport_attachments` VALUES (2, 'IS_1634784998_373.jpg', 31);
INSERT INTO `import_reexport_attachments` VALUES (3, 'IS_1634785233_203.jpg', 31);
COMMIT;
...
-- ----------------------------
-- Table structure for spmb_barang_attachment
-- ----------------------------
DROP TABLE IF EXISTS `spmb_barang_attachment`;
CREATE TABLE `spmb_barang_attachment` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL,
  `item_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Table structure for spmb_barang_attachment_temp
-- ----------------------------
DROP TABLE IF EXISTS `spmb_barang_attachment_temp`;
CREATE TABLE `spmb_barang_attachment_temp` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL,
  `key_item` varchar(64) NOT NULL,
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Records of spmb_barang_attachment_temp
-- ----------------------------
BEGIN;
INSERT INTO `spmb_barang_attachment_temp` VALUES (1, 'SPMB_1635137049_655.jpg', '1635137024335');
COMMIT;
...
CREATE TABLE `spmb_barang_temp` (
  ...
  `key_header` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `key_item` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `currency_idx_spmb_barang_temp` (`currency_id`),
  KEY `category_id_fk_id_item_category` (`category_id`),
...
-- ----------------------------
-- Records of spmb_barang_temp
-- ----------------------------
BEGIN;
INSERT INTO `spmb_barang_temp` VALUES (1, NULL, 'barang1', 1.00, '1A (Drum, steel)', 1, 2, NULL, '2021-10-25 11:44:08', '2021-10-25 11:44:08', NULL, NULL, 100000, '10', NULL, 2, 1, NULL, '123123123123123123', '1635137022724', '1635137024335');
INSERT INTO `spmb_barang_temp` VALUES (2, NULL, 'barang2', 1.00, 'SU (Suitcase)', 1, 3, NULL, '2021-10-25 11:44:44', '2021-10-25 11:44:44', NULL, NULL, 1000, '10', NULL, 4, 1, NULL, '123123123123123123', '1635137022724', '1635137059710');
COMMIT;
